<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="ProductLanding.aspx.cs" Inherits="LoopTech.ProductLanding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <asp:Image ID="ImageButton2" runat="server" ImageUrl='<%# Eval("MainImage") %>' style="padding-left:25%" />
    </div>
    <div class="carousel-item ">
        <asp:Image ID="ImageButton3" runat="server" ImageUrl='<%# Eval("Thumbnail1") %>' style="padding-left:25%" />
    </div>
    <div class="carousel-item " >
        <asp:Image ID="ImageButton4" runat="server" ImageUrl='<%# Eval("Thumbnail2") %>' style="padding-left:25%"/>
    </div>
  </div>
  ...
  <button class=" carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
            ...
            <asp:Label Text='<%# Eval("Id") %>' runat="server" ID="IdLabel" Visible="False" /><br /><br />
            <asp:Label Text='<%# Eval("ProductCode") %>' runat="server" ID="ProductCodeLabel" Font-Size="Medium"/><br />
            <asp:Label Text='<%# Eval("ModelName") %>' runat="server" ID="ModelNameLabel" Font-Size="XX-Large" Font-Bold="True" /><br />

            <asp:Label Text='<%# Eval("CostPrice") %>' runat="server" ID="CostPriceLabel" Visible="False" />
  ...
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
      <div class="accordion-body">
            ...
            <asp:Label Text='<%# Eval("HDDCapacity") %>' runat="server" ID="HDDCapacityLabel" /><br />
  ...
  <div class="accordion-item">
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:ConnectionString %>'
        SelectCommand="SELECT * FROM [Laptops] WHERE ([ProductCode] = @ProductCode)">
        <SelectParameters>
            <asp:SessionParameter SessionField="LCodeSession" Name="ProductCode"
                Type="String"></asp:SessionParameter>
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT * FROM [Laptops] WHERE ([ProductCode] = @ProductCode)">
        <SelectParameters>
            <asp:SessionParameter SessionField="LCodeSession" Name="ProductCode" Type="String"></asp:SessionParameter>
        </SelectParameters>
    </asp:SqlDataSource>
