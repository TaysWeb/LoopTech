<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Update-Watch.aspx.cs" Inherits="LoopTech.Admin.Admin.dashboard.Update_Watch" %>
  ...
  <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10A5.493 5.493 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Update Watch Details</h1>
...
<asp:TextBox ID="txtID" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label5" runat="server" Text="WatchName" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">

<asp:TextBox ID="txtWN" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label6" runat="server" Text="Category" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtCategory" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label7" runat="server" Text="Operating System" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtOP" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label8" runat="server" Text="Display Technology" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtDT" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label9" runat="server" Text="Screen Size" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtScreenSize" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label10" runat="server" Text="Brand" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtBrand" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label11" runat="server" Text="Cost Price" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtCostPrice" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label12" runat="server" Text="Selling Price" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtSellingPrice" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label13" runat="server" Text="Description" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtDescription" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label2" runat="server" Text="Connectivity" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
...
<asp:TextBox ID="txtConnectivity" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label14" runat="server" Text="Gender" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>

            <div class="col">

<asp:TextBox ID="txtGender" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
...
<asp:TextBox ID="txtMI" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label18" runat="server" Text="Thumbnail" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">

<asp:FileUpload ID="fuT" runat="server"></asp:FileUpload>

            </div>
            <div class="col" >

<asp:TextBox ID="txtT" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label19" runat="server" Text="Color" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            
            <div class="col">

<asp:TextBox ID="txtColor" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
...
<asp:BoundField DataField="WatchName" HeaderText="WatchName" SortExpression="WatchName"></asp:BoundField>
...
<asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [Id], [WatchName], [Category], [ProductCode], [OperatingSystem], [DisplayTechnology], [Screensize], [Brand], [CostPrice], [SellingPrice], [Description], [Connectivity], [Gender], [MainImage], [Thumbnail], [Color] FROM [Watches] WHERE ([ProductCode] = @ProductCode)" DeleteCommand="DELETE FROM [Watches] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Watches] ([Id], [WatchName], [Category], [ProductCode], [OperatingSystem], [DisplayTechnology], [Screensize], [Brand], [CostPrice], [SellingPrice], [Description], [Connectivity], [Gender], [MainImage], [Thumbnail], [Color]) VALUES (@Id, @WatchName, @Category, @ProductCode, @OperatingSystem, @DisplayTechnology, @Screensize, @Brand, @CostPrice, @SellingPrice, @Description, @Connectivity, @Gender, @MainImage, @Thumbnail, @Color)" UpdateCommand="UPDATE [Watches] SET [WatchName] = @WatchName, [Category] = @Category, [ProductCode] = @ProductCode, [OperatingSystem] = @OperatingSystem, [DisplayTechnology] = @DisplayTechnology, [Screensize] = @Screensize, [Brand] = @Brand, [CostPrice] = @CostPrice, [SellingPrice] = @SellingPrice, [Description] = @Description, [Connectivity] = @Connectivity, [Gender] = @Gender, [MainImage] = @MainImage, [Thumbnail] = @Thumbnail, [Color] = @Color WHERE [Id] = @Id"><DeleteParameters>
<asp:Parameter Name="Id" Type="Int32"></asp:Parameter>
</DeleteParameters>
<InsertParameters>
<asp:Parameter Name="Id" Type="Int32"></asp:Parameter>
<asp:Parameter Name="WatchName" Type="String"></asp:Parameter>
...
<UpdateParameters>
<asp:controlParameter  ControlID="txtWN" Name="WatchName" Type="String"></asp:controlParameter>
<asp:controlParameter  ControlID="txtCategory" Name="Category" Type="String"></asp:controlParameter>
...
<asp:controlParameter  ControlID="txtDT" Name="DisplayTechnology" Type="String"></asp:controlParameter>
...
<asp:controlParameter  ControlID="txtGender" Name="Gender" Type="String"></asp:controlParameter>
<asp:controlParameter  ControlID="txtMI" Name="MainImage" Type="String"></asp:controlParameter>
<asp:controlParameter  ControlID="txtT" Name="Thumbnail" Type="String"></asp:controlParameter>
<asp:controlParameter  ControlID="txtColor" Name="Color" Type="String"></asp:controlParameter>
<asp:controlParameter  ControlID="txtProductName" Name="Id" Type="Int32"></asp:controlParameter>
</UpdateParameters>
</asp:SqlDataSource>
</main>
  </div>
