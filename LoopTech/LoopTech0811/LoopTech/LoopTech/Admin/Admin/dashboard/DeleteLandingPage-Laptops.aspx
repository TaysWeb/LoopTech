<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DeleteLandingPage-Laptops.aspx.cs" Inherits="LoopTech.Admin.Admin.dashboard.DeleteLandingPage_Laptops" %>
...
<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl='<%# Eval("MainImage") %>' Width="100%" /><br />
Id: <asp:Label Text='<%# Eval("Id") %>' runat="server" id="IdLabel"/><br/>
ModelName: <asp:Label Text='<%# Eval("ModelName") %>' runat="server" id="ModelNameLabel"/><br/>
ProductCode: <asp:Label Text='<%# Eval("ProductCode") %>' runat="server" id="ProductCodeLabel"/><br/>
OperatingSystem: <asp:Label Text='<%# Eval("OperatingSystem") %>' runat="server" id="OperatingSystemLabel"/><br/>
Processor: <asp:Label Text='<%# Eval("Processor") %>' runat="server" id="ProcessorLabel"/><br/>
GraphicsCard: <asp:Label Text='<%# Eval("GraphicsCard") %>' runat="server" id="GraphicsCardLabel"/><br/>
RAMCapacity: <asp:Label Text='<%# Eval("RAMCapacity") %>' runat="server" id="RAMCapacityLabel"/><br/>
SSDCapacity: <asp:Label Text='<%# Eval("SSDCapacity") %>' runat="server" id="SSDCapacityLabel"/><br/>
Screensize: <asp:Label Text='<%# Eval("Screensize") %>' runat="server" id="ScreensizeLabel"/><br/>
SellingPrice: <asp:Label Text='<%# Eval("SellingPrice") %>' runat="server" id="SellingPriceLabel"/><br/>
MainImage: <asp:Label Text='<%# Eval("MainImage") %>' runat="server" id="MainImageLabel" Visible="False" /><br/>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource2" Visible="False"><Columns>
...
<asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description"></asp:BoundField>
            ...
            <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' DeleteCommand="DELETE FROM [Laptops] WHERE [ProductCode] = @ProductCode" InsertCommand="INSERT INTO [Laptops] ([Id], [ModelName], [ProductCode], [OperatingSystem], [DisplayTechnology], [Processor], [GraphicsCard], [RAMCapacity], [HDDCapacity], [SSDCapacity], [Screensize], [Connectivity], [Resolution], [Brand], [CostPrice], [SellingPrice], [MainImage], [Thumbnail1], [Thumbnail2], [Description]) VALUES (@Id, @ModelName, @ProductCode, @OperatingSystem, @DisplayTechnology, @Processor, @GraphicsCard, @RAMCapacity, @HDDCapacity, @SSDCapacity, @Screensize, @Connectivity, @Resolution, @Brand, @CostPrice, @SellingPrice, @MainImage, @Thumbnail1, @Thumbnail2, @Description)" SelectCommand="SELECT * FROM [Laptops]" UpdateCommand="UPDATE [Laptops] SET [ModelName] = @ModelName, [ProductCode] = @ProductCode, [OperatingSystem] = @OperatingSystem, [DisplayTechnology] = @DisplayTechnology, [Processor] = @Processor, [GraphicsCard] = @GraphicsCard, [RAMCapacity] = @RAMCapacity, [HDDCapacity] = @HDDCapacity, [SSDCapacity] = @SSDCapacity, [Screensize] = @Screensize, [Connectivity] = @Connectivity, [Resolution] = @Resolution, [Brand] = @Brand, [CostPrice] = @CostPrice, [SellingPrice] = @SellingPrice, [MainImage] = @MainImage, [Thumbnail1] = @Thumbnail1, [Thumbnail2] = @Thumbnail2, [Description] = @Description WHERE [Id] = @Id"><DeleteParameters>
...
<asp:Parameter Name="Id" Type="Int32"></asp:Parameter>
        ...
        <!---------------------------------------Content Ends Here---------------------------------------------->
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [Id], [ModelName], [ProductCode], [OperatingSystem], [Processor], [GraphicsCard], [RAMCapacity], [SSDCapacity], [Screensize], [SellingPrice], [MainImage], [Brand] FROM [Laptops] WHERE ([ProductCode] = @ProductCode)"><SelectParameters>
<asp:SessionParameter SessionField="DeleteCodeSession" Name="ProductCode" Type="String"></asp:SessionParameter>
</SelectParameters>
</asp:SqlDataSource>
</main>
        </div>
