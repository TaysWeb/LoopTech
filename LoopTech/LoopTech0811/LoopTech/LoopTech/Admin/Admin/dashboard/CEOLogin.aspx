<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="CEOLogin.aspx.cs" Inherits="LoopTech.Admin.Admin.dashboard.CEOLogin" %>
...
<div class="container-fluid">
  ...
  <path fill-rule="evenodd" d="M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2Zm6 2.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0v-7Zm3.5.878c1.482-1.42 4.795 1.392 0 4.622-4.795-3.23-1.482-6.043 0-4.622ZM2 5.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5Z"/>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		...
		<div class="CEO-con">
			...
			<h1 style="color:white;font-weight:700;">CEO Login</h1>
			
			<asp:TextBox ID="txtUsername" runat="server" placeholder="Enter Name" class="CEOtxtbox" AutoPostBack="True"></asp:TextBox>
			
			<asp:TextBox ID="txtPassKey" runat="server" placeholder="Enter Pass Key" class="CEOtxtbox" AutoPostBack="True"></asp:TextBox>
			
			<asp:Button ID="btnCEOLog" runat="server" Text="Log in"  OnClick="btnCEOLog_Click" />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="CEOLogin">
        <Columns>
    ...
    <asp:SqlDataSource ID="CEOLogin" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Id], [CeoName], [PassKey] FROM [CEO] WHERE (([CeoName] = @CeoName) AND ([PassKey] = @PassKey))">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtPassKey" Name="PassKey" PropertyName="Text" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
