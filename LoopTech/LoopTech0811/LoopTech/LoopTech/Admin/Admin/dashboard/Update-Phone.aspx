<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Update-Phone.aspx.cs" Inherits="LoopTech.Admin.Admin.dashboard.Update_Phone" %>
  ...
  <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10A5.493 5.493 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Update Phone Details</h1>
...
<asp:TextBox ID="txtID" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label2" runat="server" Text="ProductName" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">

<asp:TextBox ID="txtProductName" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label4" runat="server" Text="Brand" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtBrand" runat="server" BorderStyle="Solid" BorderColor="#333333" BorderWidth="1px" Height="35px" Width="300px"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label5" runat="server" Text="RAM" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtRAM" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label6" runat="server" Text="Features" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtFeatures" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label7" runat="server" Text="Camera" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtCamera" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label8" runat="server" Text="Screen Size" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">

<asp:TextBox ID="txtScreenSize" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label9" runat="server" Text="Storage" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtStorage" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label10" runat="server" Text="Operating System" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtOperatingSystem" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label11" runat="server" Text="Warranty" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtWarranty" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label12" runat="server" Text="Cost Price" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtCostPrice" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label13" runat="server" Text="Selling Price" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtSellingPrice" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label14" runat="server" Text="Display Technology" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>

            <div class="col">

<asp:TextBox ID="txtDisplayTechnology" runat="server"></asp:TextBox>
...
<asp:TextBox ID="txtMI" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label18" runat="server" Text="Thumbnail2" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:TextBox ID="txtT2" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label19" runat="server" Text="Thumbnail3" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">

<asp:FileUpload ID="fuT3" runat="server"></asp:FileUpload>
...
<asp:TextBox ID="txtT3" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label20" runat="server" Text="Cellular Technology" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">

<asp:TextBox ID="txtCellularTechnology" runat="server"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-2 py-2">
<asp:Label ID="Label15" runat="server" Text="Colour" Font-Size="Medium" Font-Bold="True"></asp:Label>
            </div>
            <div class="col">
...
<asp:GridView ID="GridView1" runat="server" 
          ...
          DataSourceID="SqlDataSource3" OnDataBound="GridView1_DataBound" 
          ><Columns>
...
<asp:BoundField DataField="Features" HeaderText="Features" SortExpression="Features"></asp:BoundField>
<asp:BoundField DataField="Camera" HeaderText="Camera" SortExpression="Camera"></asp:BoundField>
<asp:BoundField DataField="ScreenSize" HeaderText="ScreenSize" SortExpression="ScreenSize"></asp:BoundField>
<asp:BoundField DataField="Storage" HeaderText="Storage" SortExpression="Storage"></asp:BoundField>
...
<asp:BoundField DataField="Thumbnail3" HeaderText="Thumbnail3" SortExpression="Thumbnail3"></asp:BoundField>
<asp:BoundField DataField="CellularTechnology" HeaderText="CellularTechnology" SortExpression="CellularTechnology"></asp:BoundField>
<asp:BoundField DataField="Colour" HeaderText="Colour" SortExpression="Colour"></asp:BoundField>
</Columns>
</asp:GridView>
      
        <!---------------------------------------Content Ends Here---------------------------------------------->
    <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' DeleteCommand="DELETE FROM [Cellphones] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Cellphones] ([Id], [ProductName], [Brand], [ProductCode], [RAM], [Features], [Camera], [ScreenSize], [Storage], [OperatingSystem], [Warranty], [CostPrice], [SellingPrice], [DisplayTechnology], [MainImage], [Thumbnail2], [Thumbnail3], [CellularTechnology], [Colour]) VALUES (@Id, @ProductName, @Brand, @ProductCode, @RAM, @Features, @Camera, @ScreenSize, @Storage, @OperatingSystem, @Warranty, @CostPrice, @SellingPrice, @DisplayTechnology, @MainImage, @Thumbnail2, @Thumbnail3, @CellularTechnology, @Colour)" SelectCommand="SELECT [Id], [ProductName], [Brand], [ProductCode], [RAM], [Features], [Camera], [ScreenSize], [Storage], [OperatingSystem], [Warranty], [CostPrice], [SellingPrice], [DisplayTechnology], [MainImage], [Thumbnail2], [Thumbnail3], [CellularTechnology], [Colour] FROM [Cellphones] WHERE ([ProductCode] = @ProductCode)" UpdateCommand="UPDATE [Cellphones] SET [ProductName] = @ProductName, [Brand] = @Brand, [ProductCode] = @ProductCode, [RAM] = @RAM, [Features] = @Features, [Camera] = @Camera, [ScreenSize] = @ScreenSize, [Storage] = @Storage, [OperatingSystem] = @OperatingSystem, [Warranty] = @Warranty, [CostPrice] = @CostPrice, [SellingPrice] = @SellingPrice, [DisplayTechnology] = @DisplayTechnology, [MainImage] = @MainImage, [Thumbnail2] = @Thumbnail2, [Thumbnail3] = @Thumbnail3, [CellularTechnology] = @CellularTechnology, [Colour] = @Colour WHERE [Id] = @Id"><DeleteParameters>
...
<asp:Parameter Name="RAM" Type="String"></asp:Parameter>
<asp:Parameter Name="Features" Type="String"></asp:Parameter>
<asp:Parameter Name="Camera" Type="String"></asp:Parameter>
<asp:Parameter Name="ScreenSize" Type="String"></asp:Parameter>
<asp:Parameter Name="Storage" Type="String"></asp:Parameter>
<asp:Parameter Name="OperatingSystem" Type="String"></asp:Parameter>
<asp:Parameter Name="Warranty" Type="String"></asp:Parameter>
...
<asp:Parameter Name="Thumbnail3" Type="String"></asp:Parameter>
<asp:Parameter Name="CellularTechnology" Type="String"></asp:Parameter>
<asp:Parameter Name="Colour" Type="String"></asp:Parameter>
</InsertParameters>
<SelectParameters>
<asp:ControlParameter ControlID="ddlProductCode" PropertyName="SelectedValue" Name="ProductCode" Type="String"></asp:ControlParameter>
</SelectParameters>
<UpdateParameters>
<asp:controlParameter ControlID="txtProductName" Name="ProductName" Type="String"></asp:controlParameter>
...
<asp:controlParameter ControlID="txtRAM" Name="RAM" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtFeatures" Name="Features" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtCamera" Name="Camera" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtScreenSize" Name="ScreenSize" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtStorage" Name="Storage" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtOperatingSystem" Name="OperatingSystem" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtWarranty" Name="Warranty" Type="String"></asp:controlParameter>
...
<asp:controlParameter ControlID="txtMI" Name="MainImage" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtT2" Name="Thumbnail2" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtT3" Name="Thumbnail3" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtCellularTechnology" Name="CellularTechnology" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtColour" Name="Colour" Type="String"></asp:controlParameter>
<asp:controlParameter ControlID="txtID" Name="Id" Type="Int32"></asp:controlParameter>
</UpdateParameters>
</asp:SqlDataSource>
<asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT * FROM [Laptops]"></asp:SqlDataSource>
</main>
  </div>
</div>
