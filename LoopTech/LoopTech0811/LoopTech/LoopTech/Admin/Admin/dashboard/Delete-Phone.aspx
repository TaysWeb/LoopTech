<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Delete-Phone.aspx.cs" Inherits="LoopTech.Admin.Admin.dashboard.Delete_Phone" %>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <!---------------------------------------Content Goes Here---------------------------------------------->
        ...
        <asp:DataList ID="DataList1" runat="server" 
          ...
          RepeatDirection="Horizontal"><ItemTemplate>
...
<br/>
        ...
        <!---------------------------------------Content Ends Here---------------------------------------------->
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [MainImage], [Id], [ProductCode], [ProductName] FROM [Cellphones]"></asp:SqlDataSource>
</main>
  </div>
</div>
