<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="PhoneLandingPage.aspx.cs" Inherits="LoopTech.PhoneLandingPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DataList ID="DataList1" runat="server" 
         DataKeyField="Id" DataSourceID="SqlDataSource2" 
         Width="100%" OnItemCommand="DataList1_ItemCommand">
        <ItemTemplate>
          
            <div class="gap-4 mobilelanding d-flex my-3" style="width:100%">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <asp:Image ID="ImageButton6" runat="server" ImageUrl='<%# Eval("MainImage") %>' style="padding-left:35%"/>
        <asp:Label Text='<%# Eval("MainImage") %>' runat="server" ID="MainImageLabel" Visible="False"/>
    </div>
    <div class="carousel-item ">
        <asp:Image ID="ImageButton5" runat="server" ImageUrl='<%# Eval("Thumbnail2") %>' style="padding-left:35%"/>
        <asp:Label Text='<%# Eval("Thumbnail2") %>' runat="server" ID="Thumbnail2Label" Visible="False" />
    </div>

    <div class="carousel-item " >
        <asp:Image ID="ImageButton1" runat="server" ImageUrl='<%# Eval("Thumbnail3") %>' style="padding-left:35%"/>
        <asp:Label Text='<%# Eval("Thumbnail3") %>' runat="server" ID="Thumbnail3Label" Visible="False" />
    </div>
  </div>
  <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true" style="background-color:#000000;margin:15px;"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class=" carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    <span class=" carousel-control-next-icon" aria-hidden="true" style="background-color:#000000;margin:15px;"></span>
    <span class="visually-hidden">Next</span>
                ...
                <div class="details-width" >
                 ...
                 <asp:Label Text='<%# Eval("ProductName") %>' runat="server" ID="ProductNameLabel" Font-Size="XX-Large" Font-Bold="True"/><br />
                 <h2>R&nbsp<asp:Label Text='<%# Eval("SellingPrice") %>' runat="server" ID="SellingPriceLabel" /><br /></h2>
                    <asp:Label ID="Label2" runat="server" Text="Quantity:" Font-Bold="True"
                        BackColor="White" ForeColor="#52c5bd" Font-Size="Large"></asp:Label>&nbsp&nbsp<asp:DropDownList
                            ID="ddlQuantity" runat="server" Width="80" Height="40" AppendDataBoundItems="True"
                 ...
                 <br /><asp:Button ID="btnPhoneCart" runat="server" Text="Add To Cart"  class="btn-login"  />
  ...
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      <div class="accordion-body">
        <asp:Label Text='<%# Eval("Features") %>' runat="server" ID="FeaturesLabel" Width="100%" style="overflow:hidden"/><br />
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
      <div class="accordion-body">
            ...
            <asp:Label Text='<%# Eval("Camera") %>' runat="server" ID="CameraLabel" /><br />
            ...
            <asp:Label Text='<%# Eval("Warranty") %>' runat="server" ID="WarrantyLabel" /><br />
            
            <asp:Label Text='<%# Eval("CostPrice") %>' runat="server" ID="CostPriceLabel" /><br />
            
          
            
            <asp:Label Text='<%# Eval("DisplayTechnology") %>' runat="server" ID="DisplayTechnologyLabel" /><br />
            ...
            <asp:Label Text='<%# Eval("CellularTechnology") %>' runat="server" ID="CellularTechnologyLabel" /><br />
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT * FROM [Cellphones] WHERE ([ProductCode] = @ProductCode)">
        <SelectParameters>
